...
public GameObject GetPooledBall()
{
    ...
    {
        // deactivate the first spawned ball - or ball number one?
    ...
    void SpawnBall()
    {
        //run the object pool's picker function and create a reference to the returned object
        GameObject selectedBall = BallSpawner.current.GetPooledBall();

        //manipulate the position and velocity of the pooled bullet
